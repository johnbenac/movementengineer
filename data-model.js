{
  ...
  "entities": {
    ...
    "TextNode": {
      "description": "A piece of text within a tree structure. Depth is derived from parent/child relationships, not an explicit level label. Links to other objects are one-way: texts record which entities they mention, but not which events or claims use them.",
    ...
    "Entity": {
      "description": "Anything that exists in the world of the movement: beings, places, objects, ideas. Connections to other things are expressed through outward references from texts, practices, events, claims, and media, not editable relation records.",
