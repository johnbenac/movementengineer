...
src/models/comparisonModel.json    # Movement comparison meta-models
src/runtime/storageService.js      # LocalStorage persistence
src/runtime/domainService.js       # Snapshot mutation helpers
src/ui/graph/graphColors.js        # Graph palette helpers
src/ui/graph/graphView.js          # Graph rendering (D3)
tools/dev-server.js                # Local dev server
```
