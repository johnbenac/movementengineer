...
const services = {
  ...
  EntityGraphColors: globalThis.EntityGraphColors,
...
const ui = {
  ...createStatusUi(),
  markdown: { renderMarkdownPreview, openMarkdownModal }
};
services.ui = ui;
const dom = createDomUtils();
const utils = { values: valueUtils };
...
const enabledTabs = bootstrapOptions?.moduleTabs;
