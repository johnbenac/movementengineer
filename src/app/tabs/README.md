...
Modules that override legacy tabs should register themselves on `window.MovementEngineer.tabs` and implement the following interface:
...
- `tab.unmount(ctx)` optional: called when the legacy layer switches away or disables the module tab.
