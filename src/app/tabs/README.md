...
Tabs register themselves on `window.MovementEngineer.tabs` and implement the following interface:
...
- `tab.unmount(ctx)` optional: called when the shell switches away or disables the tab.
