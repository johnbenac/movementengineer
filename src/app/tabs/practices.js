...
const DEFAULT_TAB_STATE = { selectedPracticeId: null };

function renderPracticesTab(ctx) {
  const tab = this && this.__state ? this : ctx?.tabs?.practices;
