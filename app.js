...
(function () {
  ...
  const parseCsvInput =
    movementEngineerGlobal.utils.values.parseCsvInput ||
  ...
  const normaliseArray =
    movementEngineerGlobal.utils.values.normaliseArray ||
    function normaliseArray(value) {
      return Array.isArray(value) ? value : [];
    };
  const uniqueSorted =
    movementEngineerGlobal.utils.values.uniqueSorted ||
  ...
  const collectDescendants =
    movementEngineerGlobal.utils.values.collectDescendants ||
  ...
  Object.assign(movementEngineerGlobal.utils.values, {
    parseCsvInput,
    normaliseArray,
    uniqueSorted,
    collectDescendants
  ...
  movementEngineerGlobal.ui.markdown = movementEngineerGlobal.ui.markdown || {};
  const renderMarkdownPreview =
    movementEngineerGlobal.ui.markdown.renderMarkdownPreview ||
  ...
  const openMarkdownModal =
    movementEngineerGlobal.ui.markdown.openMarkdownModal ||
  ...
  Object.assign(movementEngineerGlobal.ui.markdown, {
  ...
  function jumpToText(textId) {
    ...
    const nextMovementId = text?.movementId || currentMovementId || null;
    activateTab('canon');
    if (!nextMovementId) {
      renderActiveTab();
      return;
    ...
    const nextState = {
      ...
      currentShelfId: shelves.length ? shelves[0] : currentShelfId
    };
