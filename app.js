...
(function () {
  ...
  function navigateHistory(direction) {
    ...
    if (tab?.navigateHistory) {
      tab.navigateHistory(movementEngineerGlobal.ctx, direction);
    }
  }
  ...
  function setCollectionAndItem(collectionName, itemId, options = {}) {
    ...
    if (tab?.setCollectionAndItem) {
      return tab.setCollectionAndItem(movementEngineerGlobal.ctx, collectionName, itemId, options);
    }
  ...
  function jumpToReferencedItem(collectionName, itemId) {
    ...
    if (tab?.jumpToReferencedItem) {
      return tab.jumpToReferencedItem(movementEngineerGlobal.ctx, collectionName, itemId);
    }
    setStatus('Collections module unavailable.');
    return null;
  }
  ...
  function saveItemFromEditor(options = {}) {
    const tab = movementEngineerGlobal.tabs?.collections;
    if (tab?.saveCurrentItem) {
      return tab.saveCurrentItem(movementEngineerGlobal.ctx, options);
    }
    setStatus('Collections module unavailable.');
    return false;
  }
